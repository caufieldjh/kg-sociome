# Contributing to kg-sociome

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
kg-sociome. These guidelines are not strict rules.
...
The kg-sociome team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the kg-sociome technical leads
...
[issues]: https://github.com/caufieldjh/kg-sociome/issues/
[pulls]: https://github.com/caufieldjh/kg-sociome/pulls/
