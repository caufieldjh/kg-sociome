...
linkml_meta = LinkMLMeta({'default_prefix': 'kg_sociome',
     ...
     'prefixes': {'PATO': {'prefix_prefix': 'PATO',
                  ...
                  'kg_sociome': {'prefix_prefix': 'kg_sociome',
                                 'prefix_reference': 'https://w3id.org/caufieldjh/kg-sociome/'},
                  'linkml': {'prefix_prefix': 'linkml',
                             'prefix_reference': 'https://w3id.org/linkml/'},
                  'schema': {'prefix_prefix': 'schema',
                             'prefix_reference': 'http://schema.org/'}},
     'see_also': ['https://caufieldjh.github.io/kg-sociome'],
     'source_file': 'src/kg_sociome/schema/kg_sociome.yaml',
     'title': 'kg-sociome'} )
...
class NamedThing(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'schema:Thing',
         'from_schema': 'https://w3id.org/caufieldjh/kg-sociome'})
...
class Person(NamedThing):
    ...
    Represents a Person
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/caufieldjh/kg-sociome',
...
class PersonCollection(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/caufieldjh/kg-sociome', 'tree_root': True})
